...
.form__switch {
    ...
    & input {
        ...
        &:focus+.form__switch__slider {
            border: 1px solid grey;
            background-color: rgb(148, 186, 101);
            transition: .4s;
        }

        &:checked+.form__switch__slider:before {
    ...
    &__slider {
        ...
        right: 0;
        bottom: 0;
        background-color: rgba(132, 177, 78, 0.7);
        border: 1px solid rgba(132, 177, 78, 0.7);
